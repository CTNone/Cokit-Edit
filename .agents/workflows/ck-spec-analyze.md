...
> Nếu bạn cần gọi các lệnh như `/ck-spec-implement, /ck-fix, /ck-spec-analyze, /ck-spec-tasks, /ck-spec-clarify, /ck-spec-specify, /ck-spec-plan`, bạn BẮT BUỘC phải đọc nội dung của các file tương ứng tại `./.agents/workflows/tên-lệnh.md` và tự động thực thi quy trình hướng dẫn trong đó để hoàn thành công việc.
