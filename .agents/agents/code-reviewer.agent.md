...
tools: ['execute/runInTerminal', 'execute/runTests', 'read/terminalLastCommand', 'vscjava.vscode-java-debug/getDebugStackTrace']
---
...
- Follow `./.agents/rules/development-rules.md` and `./docs/code-standards.md`
