...
tools: ['execute/runTask', 'execute/runInTerminal', 'agent']
---
...
**IMPORTANT**: Analyze the skills catalog at `./.agents/skills/*` and intelligently activate the skills that are needed for the task during the process.
